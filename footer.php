...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info container">
			<?php printf( __( 'Powered by %1$s.', 'newp' ), '<a href="'.esc_url("https://rohitink.com/2016/11/26/newp-mini-magazine-responsive-theme/").'" rel="nofollow">Newp WordPress Theme</a>' ); ?>
			<span class="sep"></span>
